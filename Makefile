...
IMG ?= dns-masquerading-operator-cop:latest
...
update-content: ## Update external resources used by this repository.
	...
	helm fetch oci://ghcr.io/sap/dns-masquerading-operator-helm/dns-masquerading-operator --untar --untardir pkg/operator/data/charts
